...
func Test_storageShare_encoding_decoding(t *testing.T) {
	// this test checks current storageShare struct is backward-compatible with encoded []byte
	// representation of storageShare stored in our DB, if this test fails it means we need to
	// update encoded []byte representation of storageShare stored in our DB (via DB migration)

	// use this code snippet to generate new encoded []byte representation of storageShare struct
	// we'll be expecting from now on
	//t.Run("generating new encoding for storageShare", func(t *testing.T) {
	//	stShareOld := &storageShare{
	...
	//	fmt.Println(fmt.Sprintf("stShareEncodedOld: %s", hex.EncodeToString(stShareEncodedOld)))
	//})

	t.Run("verify storageShare is backward-compatible with old encoding", func(t *testing.T) {
		stShareEncodedOldStr := ""
