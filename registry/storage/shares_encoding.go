...
// Hash: d64745a0b07e1f7cf96fa2882bff271dfa3d83079de20680ce9214e9659a0ed4
// Version: 0.1.3
package storage
...
func (s *Share) UnmarshalSSZ(buf []byte) error {
	...
	// Field (11) 'OwnerAddress'
	copy(s.OwnerAddress[:], buf[124:144])

	// Field (12) 'Liquidated'
	s.Liquidated = ssz.UnmarshalBool(buf[144:145])
