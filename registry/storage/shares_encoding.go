...
// Hash: e35a8a2310802a68e80a1e785429000a2e9908648cb661c402dd966f04fbd420
// Version: 0.1.3
package storage
...
func (s *Share) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (7) 'ActivationEpoch'
	dst = ssz.MarshalUint64(dst, s.ActivationEpoch)

	// Field (8) 'OwnerAddress'
...
func (s *Share) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (5) 'Graffiti'
	if o5 = ssz.ReadOffset(buf[68:72]); o5 > size || o3 > o5 {
		return ssz.ErrOffset
	}

	// Field (6) 'Status'
	s.Status = ssz.UnmarshallUint64(buf[72:80])

	// Field (7) 'ActivationEpoch'
	s.ActivationEpoch = ssz.UnmarshallUint64(buf[80:88])

	// Field (8) 'OwnerAddress'
	copy(s.OwnerAddress[:], buf[88:108])

	// Field (9) 'Liquidated'
	s.Liquidated = ssz.UnmarshalBool(buf[108:109])
