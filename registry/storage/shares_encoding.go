...
// Hash: e3a2c3375f966c913cafe4aa1682e59dfac1f89f0843abebe60b5f4e12522dbf
// Version: 0.1.4
package storage
...
func (s *storageShare) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (6) 'Graffiti'
	if o6 = ssz.ReadOffset(buf[132:136]); o6 > size || o3 > o6 {
		return ssz.ErrOffset
	}

	// Field (7) 'Status'
	s.Status = ssz.UnmarshallUint64(buf[136:144])

	// Field (8) 'ActivationEpoch'
	s.ActivationEpoch = ssz.UnmarshallUint64(buf[144:152])

	// Field (9) 'OwnerAddress'
	copy(s.OwnerAddress[:], buf[152:172])

	// Field (10) 'Liquidated'
	s.Liquidated = ssz.UnmarshalBool(buf[172:173])
