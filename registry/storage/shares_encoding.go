...
// Hash: 8c9e54af9fb369e4f6c60bea1c3170b324dc57c255d73b63c169fe3339c6f57d
// Version: 0.1.3
package storage
...
func (s *Share) UnmarshalSSZ(buf []byte) error {
	...
	// Field (6) 'DomainType'
	copy(s.DomainType[:], buf[80:84])

	// Field (7) 'FeeRecipientAddress'
	copy(s.FeeRecipientAddress[:], buf[84:104])

	// Offset (8) 'Graffiti'
	if o8 = ssz.ReadOffset(buf[104:108]); o8 > size || o3 > o8 {
		return ssz.ErrOffset
	}

	// Field (9) 'Status'
	s.Status = ssz.UnmarshallUint64(buf[108:116])

	// Field (10) 'ActivationEpoch'
	s.ActivationEpoch = ssz.UnmarshallUint64(buf[116:124])

	// Field (11) 'ExitEpoch'
	s.ExitEpoch = ssz.UnmarshallUint64(buf[124:132])

	// Field (12) 'OwnerAddress'
	copy(s.OwnerAddress[:], buf[132:152])

	// Field (13) 'Liquidated'
	s.Liquidated = ssz.UnmarshalBool(buf[152:153])
