...
func (i *iBFTInstance) ValidateLambda() types.PipelineFunc {
...
func (i *iBFTInstance) ValidateRound() types.PipelineFunc {
	return func(signedMessage *types.SignedMessage) error {
...
func (i *iBFTInstance) AuthMsg() types.PipelineFunc {
	return func(signedMessage *types.SignedMessage) error {
