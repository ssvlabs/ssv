...
func TestCleanInstances(t *testing.T) {
	...
	msgID := genesisspectypes.NewMsgID(genesistypes.GetDefaultDomain(), []byte("pk"), genesisspectypes.BNRoleAttester)
	...
	// add different msgID
	differMsgID := genesisspectypes.NewMsgID(genesistypes.GetDefaultDomain(), []byte("differ_pk"), genesisspectypes.BNRoleAttester)
...
func TestSaveAndFetchLastState(t *testing.T) {
	identifier := genesisspectypes.NewMsgID(genesistypes.GetDefaultDomain(), []byte("pk"), genesisspectypes.BNRoleAttester)
