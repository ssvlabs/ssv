...
// storageShareSSZ represents a Share stored in DB. SSZ encoding generator has some limitations
...
type storageShareSSZMetadata struct {
	BeaconMetadata storageShareSSZValidatorMetadata
...
type storageShareSSZValidatorMetadata struct {
	Balance         uint64
	Status          uint64
	Index           uint64
...
func specShareToStorageShareSSZ(share *types.SSVShare) *storageShareSSZ {
	...
	stShare := &storageShareSSZ{
		...
		storageShareSSZMetadata: storageShareSSZMetadata{
	...
	if share.Metadata.BeaconMetadata != nil {
		stShare.storageShareSSZMetadata.BeaconMetadata = storageShareSSZValidatorMetadata{
...
func storageKeySSZ(pk []byte) []byte {
	return bytes.Join([][]byte{sharesPrefixSSZ, pk}, []byte("/"))
}
...
// MarshalSSZ ssz marshals the storageShareSSZValidatorMetadata object
func (s *storageShareSSZValidatorMetadata) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the storageShareSSZValidatorMetadata object to a target array
func (s *storageShareSSZValidatorMetadata) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
...
// UnmarshalSSZ ssz unmarshals the storageShareSSZValidatorMetadata object
func (s *storageShareSSZValidatorMetadata) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 32 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the storageShareSSZValidatorMetadata object
func (s *storageShareSSZValidatorMetadata) SizeSSZ() (size int) {
	size = 32
	return
}

// HashTreeRoot ssz hashes the storageShareSSZValidatorMetadata object
func (s *storageShareSSZValidatorMetadata) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the storageShareSSZValidatorMetadata object with a hasher
func (s *storageShareSSZValidatorMetadata) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the storageShareSSZValidatorMetadata object
func (s *storageShareSSZValidatorMetadata) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(s)
}
