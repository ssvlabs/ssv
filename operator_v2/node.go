...
import (
	"context"
	"fmt"
	duties2 "github.com/bloxapp/ssv/operator_v2/duties"
	...
	"github.com/bloxapp/ssv/operator_v2/storage"
...
type Options struct {
	...
	DB                  basedb.IDb
	ValidatorController validator2.Controller
	...
	ValidatorOptions validator2.ControllerOptions `yaml:"ValidatorOptions"`
...
type operatorNode struct {
	ethNetwork     beaconprotocol.Network
	context        context.Context
	validatorsCtrl validator2.Controller
	logger         *zap.Logger
	beacon         beaconprotocol.Beacon
...
func New(opts Options) Node {
	...
	node := &operatorNode{
		...
		dutyCtrl: duties2.NewDutyController(&duties2.ControllerOptions{
			Logger:              opts.Logger,
			Ctx:                 opts.Context,
