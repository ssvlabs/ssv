...
func Test_ValidateSSVMessage(t *testing.T) {
	...
	t.Run("happy flow", func(t *testing.T) {
		validator := NewMessageValidator(netCfg, WithValidatorStore(ns)).(*messageValidator)
	...
	t.Run("no proposal duties", func(t *testing.T) {
		...
		validator := NewMessageValidator(netCfg, WithValidatorStore(ns), WithDutyStore(dutyStore)).(*messageValidator)
