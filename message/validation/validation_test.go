...
//
//		validSignedMessage := spectestingutils.TestingProposalMessageWithHeight(ks.OperatorKeys[1], 1, height)
...
//		_, err = validator.handleSignedSSVMessage(message, topic, receivedAt)
//		require.NoError(t, err)
//	})
//	//
...
//	//
//	//	ssvMsg.Data = encodedMsg
//	//	_, _, err = validator.handleSignedSSVMessage(ssvMsg, receivedAt.Add(netCfg.Beacon.SlotDurationSec()), nil)
//	//	require.NoError(t, err)
//	//	require.NotNil(t, state1)
...
//	//	}
//	//
//	//	_, _, err = validator.handleSignedSSVMessage(message, netCfg.Beacon.GetSlotStartTime(slot).Add(validator.waitAfterSlotStart(roleAttester)), nil)
//	//	require.NoError(t, err)
//	//
...
//	//	_, _, err = validator.handleSignedSSVMessage(message, netCfg.Beacon.GetSlotStartTime(slot+4).Add(validator.waitAfterSlotStart(roleAttester)), nil)
//	//	require.NoError(t, err)
//	//
...
//	//
//	//	message.Data = encodedValidSignedMessage
//	//	_, _, err = validator.handleSignedSSVMessage(message, netCfg.Beacon.GetSlotStartTime(slot+8).Add(validator.waitAfterSlotStart(roleAttester)), nil)
...
//	//	}
//	//
//	//	_, _, err = validator.handleSignedSSVMessage(message, netCfg.Beacon.GetSlotStartTime(slot).Add(validator.waitAfterSlotStart(spectypes.BNRoleProposer)), nil)
...
//	//		}
//	//
//	//		_, _, err = validator.handleSignedSSVMessage(ssvMessage, netCfg.Beacon.GetSlotStartTime(slot+1).Add(validator.waitAfterSlotStart(roleAttester)), nil)
//	//		require.NoError(t, err)
//	//
...
//	//
//	//		ssvMessage.Data = encodedMessage
//	//		_, _, err = validator.handleSignedSSVMessage(ssvMessage, netCfg.Beacon.GetSlotStartTime(slot).Add(validator.waitAfterSlotStart(roleAttester)), nil)
