...
func Test_ValidateSSVMessage(t *testing.T) {
	...
	committeeIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, encodedCommitteeID, committeeRole)
	nonCommitteeIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, ks.ValidatorPK.Serialize(), nonCommitteeRole)
	...
	t.Run("committee consensus accepted on boole topic post-fork", func(t *testing.T) {
		...
		booleIdentifier := ssvtestingutils.NewMsgID(postBooleCfg.DomainTypeAtSlot(slot), encodedCommitteeID, committeeRole)
	...
	t.Run("committee consensus rejected with alan domain post-fork", func(t *testing.T) {
		...
		alanDomainIdentifier := ssvtestingutils.NewMsgID(postBooleCfg.DomainType, encodedCommitteeID, committeeRole)
	...
	t.Run("committee consensus rejected with boole domain pre-fork", func(t *testing.T) {
		...
		// rejected by the slot-exact domain check.
		booleDomainIdentifier := ssvtestingutils.NewMsgID(netCfg.NextDomainType, encodedCommitteeID, committeeRole)
	...
	t.Run("ctx deadline exceeded bails before signature verify", func(t *testing.T) {
		noCallSignatureVerifier := signatureverifier.NewMockSignatureVerifier(ctrl)
		noCallSignatureVerifier.EXPECT().VerifySignature(gomock.Any(), gomock.Any(), gomock.Any()).Times(0)

		validator := New(netCfg, validatorStore, operators, dutyStore, noCallSignatureVerifier).(*messageValidator)
	...
	t.Run("partial ctx deadline exceeded bails before signature verify", func(t *testing.T) {
		noCallSignatureVerifier := signatureverifier.NewMockSignatureVerifier(ctrl)
		noCallSignatureVerifier.EXPECT().VerifySignature(gomock.Any(), gomock.Any(), gomock.Any()).Times(0)
	...
	t.Run("ctx cancellation bails before waiting on validation lock", func(t *testing.T) {
		...
		localValidatorStore := mocks.NewMockValidatorStore(localCtrl)
		localValidatorStore.EXPECT().Committee(committeeID).Return(&registrystorage.Committee{
			ID:        committeeID,
			Operators: committee,
			Shares: []*ssvtypes.SSVShare{
				share1,
		...
		noCallSignatureVerifier := signatureverifier.NewMockSignatureVerifier(localCtrl)
		noCallSignatureVerifier.EXPECT().VerifySignature(gomock.Any(), gomock.Any(), gomock.Any()).Times(0)

		validator := New(netCfg, localValidatorStore, localOperators, dutyStore, noCallSignatureVerifier).(*messageValidator)
		...
		go func() {
			_, err := validator.handleSignedSSVMessage(ctx, signedSSVMessage, topicID, peerID, receivedAt)
			errCh <- err
		}()
	...
	t.Run("message counts", func(t *testing.T) {
		...
		signedSSVMessage.FullData = nil
		_, err = validator.handleSignedSSVMessage(context.Background(), signedSSVMessage, topicID, peerID, receivedAt.Add(netCfg.SlotDuration))
		require.NoError(t, err)
	...
	t.Run("pubsub message has no data", func(t *testing.T) {
		...
		receivedAt := netCfg.SlotStartTime(slot)
		_, err := validator.handlePubsubMessage(context.Background(), pmsg, receivedAt)
	...
	t.Run("unknown validator", func(t *testing.T) {
		...
		unknown := ssvtestingutils.NewMsgID(netCfg.DomainType, sk.PublicKey().Marshal(), nonCommitteeRole)
	...
	t.Run("unknown committee ID", func(t *testing.T) {
		...
		unknownIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, unknownCommitteeID, committeeRole)
	...
	t.Run("wrong domain", func(t *testing.T) {
		...
		badIdentifier := ssvtestingutils.NewMsgID(wrongDomain, encodedCommitteeID, committeeRole)
	...
	t.Run("invalid role", func(t *testing.T) {
		...
		badIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, shares.active.ValidatorPubKey[:], math.MaxInt32)
		signedSSVMessage := generateSignedMessage(ks, badIdentifier, slot)
	...
	t.Run("invalid role with unknown executor id", func(t *testing.T) {
		...
		badIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, unknownExecutorID, math.MaxInt32)
		signedSSVMessage := generateSignedMessage(ks, badIdentifier, slot)
	...
	t.Run("aggregator committee pre-fork", func(t *testing.T) {
		...
		badIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, encodedCommitteeID, spectypes.RoleAggregatorCommittee)
		signedSSVMessage := generateSignedMessage(ks, badIdentifier, slot)
	...
	t.Run("aggregator post-fork", func(t *testing.T) {
		...
		badIdentifier := ssvtestingutils.NewMsgID(postBooleCfg.DomainTypeAtSlot(slot), shares.active.ValidatorPubKey[:], ssvtypes.RoleAggregator)
	...
	t.Run("sync committee contribution post-fork", func(t *testing.T) {
		...
		badIdentifier := ssvtestingutils.NewMsgID(postBooleCfg.DomainTypeAtSlot(slot), shares.active.ValidatorPubKey[:], ssvtypes.RoleSyncCommitteeContribution)
	...
	t.Run("non-committee role accepted on boole topic post-fork", func(t *testing.T) {
		...
		proposerIdentifier := ssvtestingutils.NewMsgID(postBooleCfg.DomainTypeAtSlot(slot), shares.active.ValidatorPubKey[:], spectypes.RoleProposer)
	...
	t.Run("non-committee role accepted on alan topic pre-fork", func(t *testing.T) {
		...
		proposerIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, shares.active.ValidatorPubKey[:], spectypes.RoleProposer)
	...
	t.Run("unexpected consensus message", func(t *testing.T) {
		...
		badIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, shares.active.ValidatorPubKey[:], spectypes.RoleValidatorRegistration)
		signedSSVMessage := generateSignedMessage(ks, badIdentifier, slot)
		...
		badIdentifier = ssvtestingutils.NewMsgID(netCfg.DomainType, shares.active.ValidatorPubKey[:], spectypes.RoleVoluntaryExit)
		signedSSVMessage = generateSignedMessage(ks, badIdentifier, slot)
	...
	t.Run("liquidated validator", func(t *testing.T) {
		...
		liquidatedIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, shares.liquidated.ValidatorPubKey[:], nonCommitteeRole)
	...
	t.Run("pending queued state validator", func(t *testing.T) {
		...
		nonUpdatedMetadataFutureEpochIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, shares.nonUpdatedMetadataFutureEpoch.ValidatorPubKey[:], nonCommitteeRole)
	...
	t.Run("too many duties", func(t *testing.T) {
		...
		identifier := ssvtestingutils.NewMsgID(netCfg.DomainType, ks.ValidatorPK.Serialize(), role)
		...
		_, err = validator.handleSignedSSVMessage(context.Background(), signedSSVMessage, topicID, peerID, netCfg.SlotStartTime(slot+4))
		require.NoError(t, err)

		// Third duty (exceeds the limit).
		signedSSVMessage = generateSignedMessage(ks, identifier, slot+8)
		_, err = validator.handleSignedSSVMessage(context.Background(), signedSSVMessage, topicID, peerID, netCfg.SlotStartTime(slot+8))
	...
	t.Run("no proposal duties", func(t *testing.T) {
		...
		identifier := ssvtestingutils.NewMsgID(netCfg.DomainType, ks.ValidatorPK.Serialize(), spectypes.RoleProposer)
		signedSSVMessage := generateSignedMessage(ks, identifier, slot)
	...
	t.Run("accept pre-consensus randao message when epoch duties are not set", func(t *testing.T) {
		...
		ssvMessage := &spectypes.SSVMessage{
			...
			MsgID:   ssvtestingutils.NewMsgID(netCfgEpoch1.DomainType, dutyExecutorID, spectypes.RoleProposer),
	...
	t.Run("partial message type validation", func(t *testing.T) {
			...
			for role, msgTypes := range tests {
				for _, msgType := range msgTypes {
					...
					t.Run(subtestName, func(t *testing.T) {
						...
						ssvMessage := &spectypes.SSVMessage{
							MsgType: spectypes.SSVPartialSignatureMsgType,
							MsgID:   ssvtestingutils.NewMsgID(netCfg.DomainType, dutyExecutorID, role),
							Data:    encodedMessages,
						}
		...
		t.Run("duplicate messages", func(t *testing.T) {
			...
			for role, msgTypes := range tests {
				for _, msgType := range msgTypes {
					...
					t.Run(subtestName, func(t *testing.T) {
						...
						require.NoError(t, err)
						_, err = validator.handleSignedSSVMessage(context.Background(), signedSSVMessage, topicID, anotherPeerID, receivedAt)
						require.ErrorIs(t, err, ErrTooManyPartialSigMessage)
						require.True(t, errors.As(err, &valErr))
			...
			t.Run(subtestName, func(t *testing.T) {
				...
				ssvMessage := &spectypes.SSVMessage{
					MsgType: spectypes.SSVPartialSignatureMsgType,
					MsgID:   ssvtestingutils.NewMsgID(postBooleCfg.DomainTypeAtSlot(slot), encodedCommitteeID, spectypes.RoleAggregatorCommittee),
					Data:    encodedMessages,
				}
	...
	t.Run("late message", func(t *testing.T) {
		...
		t.Run(message.RunnerRoleToString(spectypes.RoleAggregatorCommittee), func(t *testing.T) {
			...
			msgID := ssvtestingutils.NewMsgID(postBooleCfg.DomainTypeAtSlot(acSlot), encodedCommitteeID, spectypes.RoleAggregatorCommittee)
	...
	t.Run("nil signed ssv message", func(t *testing.T) {
		...
		_, err = validator.handleSignedSSVMessage(context.Background(), nil, "", peerID, receivedAt)
	...
	t.Run("nil ssv message", func(t *testing.T) {
		...
		_, err = validator.handleSignedSSVMessage(context.Background(), signedSSVMessage, "", peerID, receivedAt)
...
func Test_DegenerateCommittee_NeverReachesTopicValidation(t *testing.T) {
	...
	degenerateIdentifier := ssvtestingutils.NewMsgID(netCfg.DomainType, encodedDegenerateCommitteeID, spectypes.RoleCommittee)
...
func Test_ForkBoundary_TopicParity(t *testing.T) {
	...
	t.Run("last pre-fork slot accepts alan topic and rejects boole topic", func(t *testing.T) {
		...
		identifier := ssvtestingutils.NewMsgID(netCfg.DomainTypeAtSlot(slot), encodedCommitteeID, spectypes.RoleCommittee)
