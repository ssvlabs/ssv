...
func Test_ValidateSSVMessage(t *testing.T) {
	...
	nodeStorage := mockstorage.NewMockStorage(ctrl)
	...
	t.Run("no proposal duties", func(t *testing.T) {
		...
		validator := New(netCfg, nodeStorage, ds, signatureVerifier).(*messageValidator)
	...
	t.Run("accept pre-consensus randao message when epoch duties are not set", func(t *testing.T) {
		...
		validator := New(mockNetworkConfig, nodeStorage, ds, signatureVerifier).(*messageValidator)
	...
	t.Run("wrong signature", func(t *testing.T) {
		validator := New(netCfg, nodeStorage, dutyStore, wrongSignatureVerifier).(*messageValidator)
