...
func Test_ValidateSSVMessage(t *testing.T) {
	...
	t.Run("happy flow", func(t *testing.T) {
		validator := New(netCfg, validatorStore, ns, dutyStore, signatureVerifier).(*messageValidator)
	...
	t.Run("no proposal duties", func(t *testing.T) {
		...
		validator := New(netCfg, validatorStore, ns, ds, signatureVerifier).(*messageValidator)
	...
	t.Run("accept pre-consensus randao message when epoch duties are not set", func(t *testing.T) {
		...
		validator := New(mockNetworkConfig, validatorStore, ns, ds, signatureVerifier).(*messageValidator)
	...
	t.Run("wrong signature", func(t *testing.T) {
		validator := New(netCfg, validatorStore, ns, dutyStore, wrongSignatureVerifier).(*messageValidator)
