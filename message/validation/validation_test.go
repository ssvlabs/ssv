...
func Test_ValidateSSVMessage(t *testing.T) {
	...
	t.Run("happy flow", func(t *testing.T) {
		validator := New(netCfg, validatorStore, operators, ns, dutyStore, signatureVerifier, phase0.Epoch(0)).(*messageValidator)
	...
	t.Run("no proposal duties", func(t *testing.T) {
		...
		validator := New(netCfg, validatorStore, operators, ns, ds, signatureVerifier, phase0.Epoch(0)).(*messageValidator)
