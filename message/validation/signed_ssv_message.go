...
func (mv *messageValidator) validateSSVMessage(ssvMessage *spectypes.SSVMessage) error {
	...
	case spectypes.SSVConsensusMsgType, spectypes.SSVPartialSignatureMsgType, ssvmessage.SSVOBFTMsgType, ssvmessage.SSV2abOBFTMsgType, ssvmessage.SSVDKGMsgType:
		break
