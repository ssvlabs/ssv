...
func TestMessageValidator_currentEstimatedRound(t *testing.T) {
	tt := []struct {
		...
		},
		{
			...
			want:           genesisspecqbft.Round(roundtimer.QuickTimeoutThreshold) + 1,
		},
		{
		...
		},
		{
			...
			want:           genesisspecqbft.Round(roundtimer.QuickTimeoutThreshold) + 2,
		},
		{
			...
			want:           genesisspecqbft.Round(roundtimer.QuickTimeoutThreshold) + 3,
		},
		{
			...
			want:           genesisspecqbft.Round(roundtimer.QuickTimeoutThreshold) + 4,
		},
	}
