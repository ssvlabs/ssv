...
//
//	mockgen -package=signatureverifier -destination=./mock.go -source=./signature_verifier.go
//
...
func (mr *MockSignatureVerifierMockRecorder) VerifySignature(operatorID, message, signature any) *gomock.Call {
...
func (mr *MockOperatorStoreMockRecorder) GetOperatorData(r, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
