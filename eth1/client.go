...
type Options struct {
	...
	RegistryContractAddr  string        `yaml:"RegistryContractAddr" env:"REGISTRY_CONTRACT_ADDR_KEY" env-default:"0xFdFf361eD2b094730fDD8FA9658B370cE6cd4b10" env-description:"registry contract address"`
