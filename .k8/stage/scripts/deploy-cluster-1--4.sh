...
#deploy
kubectl --context=$K8S_CONTEXT apply -f .k8/stage/ssv-node-v2-1-deployment.yml || exit 1
kubectl --context=$K8S_CONTEXT apply -f .k8/stage/ssv-node-v2-2-deployment.yml || exit 1
kubectl --context=$K8S_CONTEXT apply -f .k8/stage/ssv-node-v2-3-deployment.yml || exit 1
kubectl --context=$K8S_CONTEXT apply -f .k8/stage/ssv-node-v2-4-deployment.yml || exit 1