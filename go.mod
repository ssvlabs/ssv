...
require (
	...
	github.com/bloxapp/ssv-spec v0.2.8-0.20230101070026-17ac6f1047ce
...
replace github.com/bloxapp/ssv-spec => github.com/nivBlox/ssv-spec v0.0.0-20221228133449-a5e1afbaab28
