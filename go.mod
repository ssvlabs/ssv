...
require (
	...
	github.com/bloxapp/ssv-spec v0.3.9-0.20240418193307-4b4528a2dad5 // Replaced with Alan (#cluster-consensus)
	github.com/bloxapp/ssv-spec-genesis v0.0.0
...
replace github.com/bloxapp/ssv-spec-genesis => github.com/bloxapp/ssv-spec v0.3.7 // Genesis
