...
// Source: github.com/ssvlabs/ssv/v2/eth/eventhandler (interfaces: TaskExecutor)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=./mocks/task_executor.go github.com/ssvlabs/ssv/v2/eth/eventhandler TaskExecutor
//
