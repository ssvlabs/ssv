...
//
//	mockgen -package=mocks -destination=./mocks/execution_client.go -source=./execution_client.go
//
...
func (m *MockProvider) FetchHistoricalLogs(ctx context.Context, fromBlock uint64) (<-chan executionclient.BlockLogs, <-chan error, error) {
	m.ctrl.T.Helper()
...
func (m *MockProvider) StreamLogs(ctx context.Context, fromBlock uint64) <-chan executionclient.BlockLogs {
	m.ctrl.T.Helper()
...
// FetchHistoricalLogs mocks base method.
func (m *MockSingleClientProvider) FetchHistoricalLogs(ctx context.Context, fromBlock uint64) (<-chan executionclient.BlockLogs, <-chan error, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchHistoricalLogs", ctx, fromBlock)
	ret0, _ := ret[0].(<-chan executionclient.BlockLogs)
	ret1, _ := ret[1].(<-chan error)
...
// StreamLogs mocks base method.
func (m *MockSingleClientProvider) StreamLogs(ctx context.Context, fromBlock uint64) <-chan executionclient.BlockLogs {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StreamLogs", ctx, fromBlock)
	ret0, _ := ret[0].(<-chan executionclient.BlockLogs)
	return ret0
...
func (m *MockSingleClientProvider) streamLogsToChan(ctx context.Context, logCh chan<- executionclient.BlockLogs, fromBlock uint64) (uint64, error) {
	m.ctrl.T.Helper()
