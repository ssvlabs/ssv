...
type Options struct {
	...
	ConnectionTimeout     time.Duration `yaml:"ETH1ConnectionTimeout" env:"ETH_1_CONNECTION_TIMEOUT" env-default:"15s" env-description:"Timeout for execution client requests"`
