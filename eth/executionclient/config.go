...
type ExecutionOptions struct {
	...
	SyncTolerance     uint64        `yaml:"ETH1SyncTolerance" env:"ETH_1_SYNC_TOLERANCE" env-required:"false" env-default:"2" env-description:"The numbers of out-of-sync blocks we can tolerate"`
}
