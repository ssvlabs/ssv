...
type ExecutionOptions struct {
	...
	SyncDistanceTolerance uint64        `yaml:"ETH1SyncDistanceTolerance" env:"ETH_1_SYNC_DISTANCE_TOLERANCE" env-required:"false" env-default:"4" env-description:"The number of out-of-sync blocks we can tolerate"`
}
