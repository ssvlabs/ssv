...
type Options struct {
	Addr                  string        `yaml:"ETH1Addr" env:"ETH_1_ADDR" env-required:"true" env-description:"Execution client WebSocket URLs (semicolon-separated, e.g. 'ws://localhost:8546;ws://localhost:8547')"`
