...
// has B_0 = 2·BTT + RefloodDelay (consensustest uses RefloodDelay=0 so
// B_0 = 2·BTT); adding 6·BTT delay pushes the bundle to T_commit + 4·BTT,
// past T_commit at all receivers. Hardcoded delay would silently fail at
// BTT > 200ms.
