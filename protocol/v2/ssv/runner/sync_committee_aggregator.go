...
func (r *SyncCommitteeAggregatorRunner) ProcessPreConsensus(signedMsg *ssv.SignedPartialSignatureMessage) error {
...
func (r *SyncCommitteeAggregatorRunner) ProcessPostConsensus(signedMsg *ssv.SignedPartialSignatureMessage) error {
...
func (r *SyncCommitteeAggregatorRunner) GetNetwork() ssv.Network {
	return r.network
}

func (r *SyncCommitteeAggregatorRunner) GetBeaconNode() ssv.BeaconNode {
	return r.beacon
}
