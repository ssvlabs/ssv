...
//
// Mirror of the twoab bridge's helper of the same name (different
// package — the two copies are intentionally siblings per the project's
// "don't over-DRY across protocol packages" guidance).
