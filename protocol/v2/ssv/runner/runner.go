...
func NewBaseRunner(
	state *State,
	share map[spec.ValidatorIndex]*spectypes.Share,
...
func (b *BaseRunner) baseStartNewNonBeaconDuty(logger *zap.Logger, runner Runner, duty *spectypes.BeaconDuty) error {
