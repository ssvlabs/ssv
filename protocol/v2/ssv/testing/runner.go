...
var ConstructBaseRunner = func(
	...
	case spectypes.RoleProposer:
		valCheck = ssv.ProposerValueCheckF(km, networkconfig.TestBeacon,
	...
	case spectypes.RoleAggregator:
		valCheck = ssv.AggregatorValueCheckF(km, networkconfig.TestBeacon,
			(spectypes.ValidatorPK)(spectestingutils.TestingValidatorPubKey), spectestingutils.TestingValidatorIndex)
	case spectypes.RoleSyncCommitteeContribution:
		valCheck = ssv.SyncCommitteeContributionValueCheckF(km, networkconfig.TestBeacon,
			(spectypes.ValidatorPK)(spectestingutils.TestingValidatorPubKey), spectestingutils.TestingValidatorIndex)
	default:
		valCheck = nil
	}
