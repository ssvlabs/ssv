...
var ConstructBaseRunner = func(
	...
	case spectypes.RoleProposer:
		valCheck = ssv.ProposerValueCheckF(km, networkconfig.TestBeaconConfig,
	...
	case spectypes.RoleAggregator:
		valCheck = ssv.AggregatorValueCheckF(km, networkconfig.TestBeaconConfig,
			(spectypes.ValidatorPK)(spectestingutils.TestingValidatorPubKey), spectestingutils.TestingValidatorIndex)
	case spectypes.RoleSyncCommitteeContribution:
		valCheck = ssv.SyncCommitteeContributionValueCheckF(km, networkconfig.TestBeaconConfig,
			(spectypes.ValidatorPK)(spectestingutils.TestingValidatorPubKey), spectestingutils.TestingValidatorIndex)
	default:
		valCheck = nil
	}
