...
// KyberSigner is a tbft.Signer backed by drand's kyber-bls12381. It exists
...
func (k *KyberSigner) AggregatePartials(partials map[tbft.OperatorID]tbft.Signature) (tbft.Signature, error) {
	if len(partials) == 0 {
...
func (k *KyberSigner) VerifyAggregate(clusterPubKey []byte, msg []byte, sig tbft.Signature) bool {
