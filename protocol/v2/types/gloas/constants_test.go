...
func TestWireConstants(t *testing.T) {
	require.Equal(t, spectypes.RunnerRole(7), RolePTC)
	require.Equal(t, spectypes.RunnerRole(8), RoleProposerPreferences)
	require.Equal(t, spectypes.RunnerRole(9), RoleEnvelope)

	require.Equal(t, spectypes.BeaconRole(7), BNRolePTC)
	require.Equal(t, spectypes.BeaconRole(8), BNRoleProposerPreferences)
	require.Equal(t, spectypes.BeaconRole(9), BNRoleEnvelope)
	...
	require.Equal(t, spectypes.PartialSigMsgType(9), EnvelopePartialSig)
