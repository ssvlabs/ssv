...
// The SSV Gloas types are SSZ-encoded by pk910/dynamic-ssz, composing go-eth2-client's dynamic-ssz
// spec/gloas types (aliased in spec_aliases.go). Regenerate with `go generate ./...`.
//
