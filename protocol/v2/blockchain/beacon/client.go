...
type Options struct {
	...
	Graffiti       []byte
	GasLimit       uint64 `yaml:"GasLimit" env:"GAS_LIMIT" env-default:"30000000" env-description:"Gas limit used for beacon node actions"` // value is from validator.DefaultGasLimit
}
