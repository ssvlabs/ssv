...
type Options struct {
	...
	Network                     Network
	BeaconNodeAddr              string `yaml:"BeaconNodeAddr" env:"BEACON_NODE_ADDR" env-required:"true" env-description:"Beacon node URLs (semicolon-separated, e.g. 'http://localhost:5052;http://localhost:5053')"`
