...
func (m *MockBeaconNetwork) String() string {
	m.ctrl.T.Helper()
...
func (mr *MockBeaconNetworkMockRecorder) String() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "String", reflect.TypeOf((*MockBeaconNetwork)(nil).String))
}

// MockSpecNetwork is a mock of SpecNetwork interface.
type MockSpecNetwork struct {
	ctrl     *gomock.Controller
	recorder *MockSpecNetworkMockRecorder
}

// MockSpecNetworkMockRecorder is the mock recorder for MockSpecNetwork.
type MockSpecNetworkMockRecorder struct {
	mock *MockSpecNetwork
}

// NewMockSpecNetwork creates a new mock instance.
func NewMockSpecNetwork(ctrl *gomock.Controller) *MockSpecNetwork {
	mock := &MockSpecNetwork{ctrl: ctrl}
	mock.recorder = &MockSpecNetworkMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSpecNetwork) EXPECT() *MockSpecNetworkMockRecorder {
	return m.recorder
}

// EpochStartTime mocks base method.
func (m *MockSpecNetwork) EpochStartTime(epoch phase0.Epoch) time.Time {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EpochStartTime", epoch)
	ret0, _ := ret[0].(time.Time)
	return ret0
...
// EpochStartTime indicates an expected call of EpochStartTime.
func (mr *MockSpecNetworkMockRecorder) EpochStartTime(epoch interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EpochStartTime", reflect.TypeOf((*MockSpecNetwork)(nil).EpochStartTime), epoch)
}

// EstimatedCurrentEpoch mocks base method.
func (m *MockSpecNetwork) EstimatedCurrentEpoch() phase0.Epoch {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimatedCurrentEpoch")
	ret0, _ := ret[0].(phase0.Epoch)
	return ret0
...
// EstimatedCurrentEpoch indicates an expected call of EstimatedCurrentEpoch.
func (mr *MockSpecNetworkMockRecorder) EstimatedCurrentEpoch() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimatedCurrentEpoch", reflect.TypeOf((*MockSpecNetwork)(nil).EstimatedCurrentEpoch))
}

// EstimatedCurrentSlot mocks base method.
func (m *MockSpecNetwork) EstimatedCurrentSlot() phase0.Slot {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimatedCurrentSlot")
	ret0, _ := ret[0].(phase0.Slot)
	return ret0
...
// EstimatedCurrentSlot indicates an expected call of EstimatedCurrentSlot.
func (mr *MockSpecNetworkMockRecorder) EstimatedCurrentSlot() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimatedCurrentSlot", reflect.TypeOf((*MockSpecNetwork)(nil).EstimatedCurrentSlot))
}

// EstimatedEpochAtSlot mocks base method.
func (m *MockSpecNetwork) EstimatedEpochAtSlot(slot phase0.Slot) phase0.Epoch {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimatedEpochAtSlot", slot)
	ret0, _ := ret[0].(phase0.Epoch)
	return ret0
...
// EstimatedEpochAtSlot indicates an expected call of EstimatedEpochAtSlot.
func (mr *MockSpecNetworkMockRecorder) EstimatedEpochAtSlot(slot interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimatedEpochAtSlot", reflect.TypeOf((*MockSpecNetwork)(nil).EstimatedEpochAtSlot), slot)
}

// EstimatedSlotAtTime mocks base method.
func (m *MockSpecNetwork) EstimatedSlotAtTime(time int64) phase0.Slot {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimatedSlotAtTime", time)
	ret0, _ := ret[0].(phase0.Slot)
	return ret0
...
// EstimatedSlotAtTime indicates an expected call of EstimatedSlotAtTime.
func (mr *MockSpecNetworkMockRecorder) EstimatedSlotAtTime(time interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimatedSlotAtTime", reflect.TypeOf((*MockSpecNetwork)(nil).EstimatedSlotAtTime), time)
}

// EstimatedTimeAtSlot mocks base method.
func (m *MockSpecNetwork) EstimatedTimeAtSlot(slot phase0.Slot) int64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimatedTimeAtSlot", slot)
	ret0, _ := ret[0].(int64)
	return ret0
...
// EstimatedTimeAtSlot indicates an expected call of EstimatedTimeAtSlot.
func (mr *MockSpecNetworkMockRecorder) EstimatedTimeAtSlot(slot interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimatedTimeAtSlot", reflect.TypeOf((*MockSpecNetwork)(nil).EstimatedTimeAtSlot), slot)
}

// FirstSlotAtEpoch mocks base method.
func (m *MockSpecNetwork) FirstSlotAtEpoch(epoch phase0.Epoch) phase0.Slot {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FirstSlotAtEpoch", epoch)
	ret0, _ := ret[0].(phase0.Slot)
	return ret0
...
// FirstSlotAtEpoch indicates an expected call of FirstSlotAtEpoch.
func (mr *MockSpecNetworkMockRecorder) FirstSlotAtEpoch(epoch interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FirstSlotAtEpoch", reflect.TypeOf((*MockSpecNetwork)(nil).FirstSlotAtEpoch), epoch)
}

// ForkVersion mocks base method.
func (m *MockSpecNetwork) ForkVersion() [4]byte {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ForkVersion")
	ret0, _ := ret[0].([4]byte)
	return ret0
...
// ForkVersion indicates an expected call of ForkVersion.
func (mr *MockSpecNetworkMockRecorder) ForkVersion() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForkVersion", reflect.TypeOf((*MockSpecNetwork)(nil).ForkVersion))
}

// MinGenesisTime mocks base method.
func (m *MockSpecNetwork) MinGenesisTime() uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MinGenesisTime")
	ret0, _ := ret[0].(uint64)
	return ret0
...
// MinGenesisTime indicates an expected call of MinGenesisTime.
func (mr *MockSpecNetworkMockRecorder) MinGenesisTime() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MinGenesisTime", reflect.TypeOf((*MockSpecNetwork)(nil).MinGenesisTime))
}

// SlotDurationSec mocks base method.
func (m *MockSpecNetwork) SlotDurationSec() time.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SlotDurationSec")
	ret0, _ := ret[0].(time.Duration)
	return ret0
...
// SlotDurationSec indicates an expected call of SlotDurationSec.
func (mr *MockSpecNetworkMockRecorder) SlotDurationSec() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SlotDurationSec", reflect.TypeOf((*MockSpecNetwork)(nil).SlotDurationSec))
}

// SlotsPerEpoch mocks base method.
func (m *MockSpecNetwork) SlotsPerEpoch() uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SlotsPerEpoch")
	ret0, _ := ret[0].(uint64)
	return ret0
...
// SlotsPerEpoch indicates an expected call of SlotsPerEpoch.
func (mr *MockSpecNetworkMockRecorder) SlotsPerEpoch() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SlotsPerEpoch", reflect.TypeOf((*MockSpecNetwork)(nil).SlotsPerEpoch))
}
