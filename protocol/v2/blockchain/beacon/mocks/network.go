...
// GetEpochLastSlot mocks base method.
func (m *MockBeaconNetwork) GetEpochLastSlot(epoch phase0.Epoch) phase0.Slot {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEpochLastSlot", epoch)
	ret0, _ := ret[0].(phase0.Slot)
	return ret0
}

// GetEpochLastSlot indicates an expected call of GetEpochLastSlot.
func (mr *MockBeaconNetworkMockRecorder) GetEpochLastSlot(epoch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEpochLastSlot", reflect.TypeOf((*MockBeaconNetwork)(nil).GetEpochLastSlot), epoch)
}
