...
// Source: ./protocol/v2/blockchain/beacon/network.go
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=./protocol/v2/blockchain/beacon/mocks/network.go -source=./protocol/v2/blockchain/beacon/network.go
//
