...
func (mr *MockBeaconNodeMockRecorder) DataVersion(epoch interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBeaconNodeMockRecorder) GetAttestationData(slot interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockBeaconNode) SubmitAttestations(attestations []*types.VersionedAttestationResponse) error {
	m.ctrl.T.Helper()
...
func (mr *MockBeaconNodeMockRecorder) SubmitValidatorRegistration(registration interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
