...
//
//	mockgen -source=client.go -destination mock_client.go
//
...
import (
	...
	go_eth2_client "github.com/attestantio/go-eth2-client"
...
func (m *MockbeaconDuties) Events(ctx context.Context, topics []string, handler go_eth2_client.EventHandlerFunc) error {
	m.ctrl.T.Helper()
...
// MockTempSpecProposerCalls is a mock of TempSpecProposerCalls interface.
type MockTempSpecProposerCalls struct {
	ctrl     *gomock.Controller
	recorder *MockTempSpecProposerCallsMockRecorder
}

// MockTempSpecProposerCallsMockRecorder is the mock recorder for MockTempSpecProposerCalls.
type MockTempSpecProposerCallsMockRecorder struct {
	mock *MockTempSpecProposerCalls
}

// NewMockTempSpecProposerCalls creates a new mock instance.
func NewMockTempSpecProposerCalls(ctrl *gomock.Controller) *MockTempSpecProposerCalls {
	mock := &MockTempSpecProposerCalls{ctrl: ctrl}
	mock.recorder = &MockTempSpecProposerCallsMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockTempSpecProposerCalls) EXPECT() *MockTempSpecProposerCallsMockRecorder {
	return m.recorder
}

// GetBeaconBlock mocks base method.
func (m *MockTempSpecProposerCalls) GetBeaconBlock(slot phase0.Slot, graffiti, randao []byte) (fastssz.Marshaler, spec.DataVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBeaconBlock", slot, graffiti, randao)
	ret0, _ := ret[0].(fastssz.Marshaler)
...
func (mr *MockTempSpecProposerCallsMockRecorder) GetBeaconBlock(slot, graffiti, randao any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBeaconBlock", reflect.TypeOf((*MockTempSpecProposerCalls)(nil).GetBeaconBlock), slot, graffiti, randao)
}

// SubmitBeaconBlock mocks base method.
func (m *MockTempSpecProposerCalls) SubmitBeaconBlock(block *api.VersionedProposal, sig phase0.BLSSignature) error {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecProposerCallsMockRecorder) SubmitBeaconBlock(block, sig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitBeaconBlock", reflect.TypeOf((*MockTempSpecProposerCalls)(nil).SubmitBeaconBlock), block, sig)
}

// SubmitBlindedBeaconBlock mocks base method.
func (m *MockTempSpecProposerCalls) SubmitBlindedBeaconBlock(block *api.VersionedBlindedProposal, sig phase0.BLSSignature) error {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecProposerCallsMockRecorder) SubmitBlindedBeaconBlock(block, sig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitBlindedBeaconBlock", reflect.TypeOf((*MockTempSpecProposerCalls)(nil).SubmitBlindedBeaconBlock), block, sig)
}

// MockTempSpecBeaconNode is a mock of TempSpecBeaconNode interface.
type MockTempSpecBeaconNode struct {
	ctrl     *gomock.Controller
	recorder *MockTempSpecBeaconNodeMockRecorder
}

// MockTempSpecBeaconNodeMockRecorder is the mock recorder for MockTempSpecBeaconNode.
type MockTempSpecBeaconNodeMockRecorder struct {
	mock *MockTempSpecBeaconNode
}

// NewMockTempSpecBeaconNode creates a new mock instance.
func NewMockTempSpecBeaconNode(ctrl *gomock.Controller) *MockTempSpecBeaconNode {
	mock := &MockTempSpecBeaconNode{ctrl: ctrl}
	mock.recorder = &MockTempSpecBeaconNodeMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockTempSpecBeaconNode) EXPECT() *MockTempSpecBeaconNodeMockRecorder {
	return m.recorder
}

// DomainData mocks base method.
func (m *MockTempSpecBeaconNode) DomainData(epoch phase0.Epoch, domain phase0.DomainType) (phase0.Domain, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) DomainData(epoch, domain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DomainData", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).DomainData), epoch, domain)
}

// GetAttestationData mocks base method.
func (m *MockTempSpecBeaconNode) GetAttestationData(slot phase0.Slot, committeeIndex phase0.CommitteeIndex) (*phase0.AttestationData, spec.DataVersion, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) GetAttestationData(slot, committeeIndex any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAttestationData", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).GetAttestationData), slot, committeeIndex)
}

// GetBeaconBlock mocks base method.
func (m *MockTempSpecBeaconNode) GetBeaconBlock(slot phase0.Slot, graffiti, randao []byte) (fastssz.Marshaler, spec.DataVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBeaconBlock", slot, graffiti, randao)
	ret0, _ := ret[0].(fastssz.Marshaler)
	ret1, _ := ret[1].(spec.DataVersion)
...
// GetBeaconBlock indicates an expected call of GetBeaconBlock.
func (mr *MockTempSpecBeaconNodeMockRecorder) GetBeaconBlock(slot, graffiti, randao any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBeaconBlock", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).GetBeaconBlock), slot, graffiti, randao)
}

// GetBeaconNetwork mocks base method.
func (m *MockTempSpecBeaconNode) GetBeaconNetwork() types.BeaconNetwork {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) GetBeaconNetwork() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBeaconNetwork", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).GetBeaconNetwork))
}

// GetSyncCommitteeContribution mocks base method.
func (m *MockTempSpecBeaconNode) GetSyncCommitteeContribution(slot phase0.Slot, selectionProofs []phase0.BLSSignature, subnetIDs []uint64) (fastssz.Marshaler, spec.DataVersion, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) GetSyncCommitteeContribution(slot, selectionProofs, subnetIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSyncCommitteeContribution", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).GetSyncCommitteeContribution), slot, selectionProofs, subnetIDs)
}

// GetSyncMessageBlockRoot mocks base method.
func (m *MockTempSpecBeaconNode) GetSyncMessageBlockRoot(slot phase0.Slot) (phase0.Root, spec.DataVersion, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) GetSyncMessageBlockRoot(slot any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSyncMessageBlockRoot", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).GetSyncMessageBlockRoot), slot)
}

// IsSyncCommitteeAggregator mocks base method.
func (m *MockTempSpecBeaconNode) IsSyncCommitteeAggregator(proof []byte) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) IsSyncCommitteeAggregator(proof any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsSyncCommitteeAggregator", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).IsSyncCommitteeAggregator), proof)
}

// SubmitAggregateSelectionProof mocks base method.
func (m *MockTempSpecBeaconNode) SubmitAggregateSelectionProof(slot phase0.Slot, committeeIndex phase0.CommitteeIndex, committeeLength uint64, index phase0.ValidatorIndex, slotSig []byte) (fastssz.Marshaler, spec.DataVersion, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitAggregateSelectionProof(slot, committeeIndex, committeeLength, index, slotSig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitAggregateSelectionProof", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitAggregateSelectionProof), slot, committeeIndex, committeeLength, index, slotSig)
}

// SubmitAttestation mocks base method.
func (m *MockTempSpecBeaconNode) SubmitAttestation(attestation *phase0.Attestation) error {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitAttestation(attestation any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitAttestation", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitAttestation), attestation)
}

// SubmitBeaconBlock mocks base method.
func (m *MockTempSpecBeaconNode) SubmitBeaconBlock(block *api.VersionedProposal, sig phase0.BLSSignature) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubmitBeaconBlock", block, sig)
	ret0, _ := ret[0].(error)
	return ret0
...
// SubmitBeaconBlock indicates an expected call of SubmitBeaconBlock.
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitBeaconBlock(block, sig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitBeaconBlock", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitBeaconBlock), block, sig)
}

// SubmitBlindedBeaconBlock mocks base method.
func (m *MockTempSpecBeaconNode) SubmitBlindedBeaconBlock(block *api.VersionedBlindedProposal, sig phase0.BLSSignature) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubmitBlindedBeaconBlock", block, sig)
	ret0, _ := ret[0].(error)
	return ret0
...
// SubmitBlindedBeaconBlock indicates an expected call of SubmitBlindedBeaconBlock.
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitBlindedBeaconBlock(block, sig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitBlindedBeaconBlock", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitBlindedBeaconBlock), block, sig)
}

// SubmitSignedAggregateSelectionProof mocks base method.
func (m *MockTempSpecBeaconNode) SubmitSignedAggregateSelectionProof(msg *phase0.SignedAggregateAndProof) error {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitSignedAggregateSelectionProof(msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitSignedAggregateSelectionProof", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitSignedAggregateSelectionProof), msg)
}

// SubmitSignedContributionAndProof mocks base method.
func (m *MockTempSpecBeaconNode) SubmitSignedContributionAndProof(contribution *altair.SignedContributionAndProof) error {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitSignedContributionAndProof(contribution any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitSignedContributionAndProof", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitSignedContributionAndProof), contribution)
}

// SubmitSyncMessage mocks base method.
func (m *MockTempSpecBeaconNode) SubmitSyncMessage(msg *altair.SyncCommitteeMessage) error {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitSyncMessage(msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitSyncMessage", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitSyncMessage), msg)
}

// SubmitValidatorRegistration mocks base method.
func (m *MockTempSpecBeaconNode) SubmitValidatorRegistration(pubkey []byte, feeRecipient bellatrix.ExecutionAddress, sig phase0.BLSSignature) error {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitValidatorRegistration(pubkey, feeRecipient, sig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitValidatorRegistration", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitValidatorRegistration), pubkey, feeRecipient, sig)
}

// SubmitVoluntaryExit mocks base method.
func (m *MockTempSpecBeaconNode) SubmitVoluntaryExit(voluntaryExit *phase0.SignedVoluntaryExit) error {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) SubmitVoluntaryExit(voluntaryExit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitVoluntaryExit", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SubmitVoluntaryExit), voluntaryExit)
}

// SyncCommitteeSubnetID mocks base method.
func (m *MockTempSpecBeaconNode) SyncCommitteeSubnetID(index phase0.CommitteeIndex) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTempSpecBeaconNodeMockRecorder) SyncCommitteeSubnetID(index any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SyncCommitteeSubnetID", reflect.TypeOf((*MockTempSpecBeaconNode)(nil).SyncCommitteeSubnetID), index)
}
...
// Events mocks base method.
func (m *MockBeaconNode) Events(ctx context.Context, topics []string, handler go_eth2_client.EventHandlerFunc) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Events", ctx, topics, handler)
	ret0, _ := ret[0].(error)
	return ret0
...
// GetBeaconBlock mocks base method.
func (m *MockBeaconNode) GetBeaconBlock(slot phase0.Slot, graffiti, randao []byte) (fastssz.Marshaler, spec.DataVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBeaconBlock", slot, graffiti, randao)
	ret0, _ := ret[0].(fastssz.Marshaler)
	ret1, _ := ret[1].(spec.DataVersion)
...
// GetSyncCommitteeContribution mocks base method.
func (m *MockBeaconNode) GetSyncCommitteeContribution(slot phase0.Slot, selectionProofs []phase0.BLSSignature, subnetIDs []uint64) (fastssz.Marshaler, spec.DataVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSyncCommitteeContribution", slot, selectionProofs, subnetIDs)
	ret0, _ := ret[0].(fastssz.Marshaler)
	ret1, _ := ret[1].(spec.DataVersion)
...
// SubmitAggregateSelectionProof mocks base method.
func (m *MockBeaconNode) SubmitAggregateSelectionProof(slot phase0.Slot, committeeIndex phase0.CommitteeIndex, committeeLength uint64, index phase0.ValidatorIndex, slotSig []byte) (fastssz.Marshaler, spec.DataVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubmitAggregateSelectionProof", slot, committeeIndex, committeeLength, index, slotSig)
	ret0, _ := ret[0].(fastssz.Marshaler)
	ret1, _ := ret[1].(spec.DataVersion)
...
// SubmitAttestation indicates an expected call of SubmitAttestation.
func (mr *MockBeaconNodeMockRecorder) SubmitAttestation(attestation any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SubmitSyncMessage indicates an expected call of SubmitSyncMessage.
func (mr *MockBeaconNodeMockRecorder) SubmitSyncMessage(msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
