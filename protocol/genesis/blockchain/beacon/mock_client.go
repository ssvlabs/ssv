...
//
//	mockgen -package=genesisbeacon -destination=./mock_client.go -source=./beacon.go
//

// Package genesisbeacon is a generated GoMock package.
...
func (mr *MockBeaconNodeMockRecorder) GetBlindedBeaconBlock(slot, graffiti, randao any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
