...
func (v *Validator) GetLastHeight(identifier genesisspectypes.MessageID) specqbft.Height {
...
func (v *Validator) GetLastRound(identifier genesisspectypes.MessageID) specqbft.Round {
	r := v.DutyRunners.DutyRunnerForMsgID(identifier)
	if r == nil {
