...
func TestConvertDutyRunner(t *testing.T) {
	...
	rootOutput := []byte("5dfb3ba03010b92fcd7404dc1f8e7d43e0ebfcdbe63e46fec25c358d500eb26f")
	...
	for _, msg := range jsonToMsgs(t, msgsInput, message.NewIdentifier(keysSet.ValidatorPK.Serialize(), message.RoleTypeAttester)) {
