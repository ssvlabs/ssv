...
func TestPreparePipeline(t *testing.T) {
	...
	require.EqualValues(t, "combination of: validate proposal, combination of: combination of: basic msg validation, type check, lambda, sequence, authorize, , add prepare msg, , upon prepare msg, ", pipeline.Name())
}
