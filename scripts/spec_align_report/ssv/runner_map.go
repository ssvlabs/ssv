...
func RunnerSet() []utils.KeyValue {
	...
	runnerSet.Set("\"github.com/bloxapp/ssv/protocol/qbft/controller\"\n", "")
...
func RunnerStateSet() []utils.KeyValue {
	...
	mapSet.Set("\"github.com/bloxapp/ssv/protocol/qbft/instance\"", "")
	mapSet.Set("specssv.", "")
...
func AggregatorSet() []utils.KeyValue {
	...
	mapSet.Set("\"github.com/bloxapp/ssv/protocol/qbft/controller\"\n", "")
