...
func validatorSet() []utils.KeyValue {
	...
	mapSet.Set("\"github.com/bloxapp/ssv/protocol/message\"\n", "")
	...
	mapSet.Set("\"github.com/bloxapp/ssv/protocol/ssv/msgqueue\"\n", "")
	mapSet.Set("\"github.com/bloxapp/ssv/protocol/ssv/runner\"\n", "")
	mapSet.Set("\"github.com/bloxapp/ssv/protocol/types\"\n", "")
