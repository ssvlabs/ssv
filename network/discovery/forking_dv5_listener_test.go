...
func TestForkListener_Create(t *testing.T) {
	...
	t.Run("Pre-Fork", func(t *testing.T) {
		...
		_ = newForkingDV5Listener(zap.NewNop(), preForkListener, postForkListener, netCfg)
...
func TestForkListener_Lookup(t *testing.T) {
	...
	t.Run("Pre-Fork", func(t *testing.T) {
		netCfg := PreForkNetworkConfig()
		forkListener := newForkingDV5Listener(zap.NewNop(), preForkListener, postForkListener, netCfg)
