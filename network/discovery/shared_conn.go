...
const (
	...
	// Size taken from https://github.com/ethereum/go-ethereum/blob/v1.17.5/p2p/server.go#L465
...
// Adapted from go-ethereum's sharedUDPConn: https://github.com/ethereum/go-ethereum/blob/v1.17.5/p2p/server.go#L335
//
