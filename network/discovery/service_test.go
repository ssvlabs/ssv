...
func TestNewDiscV5Service(t *testing.T) {
	...
	// Check bootnodes
	CheckBootnodes(t, dvs, networkconfig.TestSSVConfig)
...
func TestDiscV5Service_PublishENR(t *testing.T) {
	...
	opts := testingDiscoveryOptions(t, networkconfig.TestSSVConfig)
	...
	checkLocalNodeDomainTypeAlignment(t, localNode, networkconfig.TestSSVConfig)

	// Change network config
	dvs.ssvConfig = networkconfig.TestSSVConfig
...
func TestDiscV5Service_checkPeer(t *testing.T) {
	...
	err = dvs.checkPeer(context.TODO(), ToPeerEvent(NodeWithCustomDomains(t, networkconfig.TestSSVConfig.DomainType, spectypes.DomainType{})))
	require.NoError(t, err)

	// Matching next domain
	err = dvs.checkPeer(context.TODO(), ToPeerEvent(NodeWithCustomDomains(t, spectypes.DomainType{}, networkconfig.TestSSVConfig.DomainType)))
