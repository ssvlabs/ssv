...
type Network interface {
	...
	GetCurrentInstanceLastChangeRoundMsg(peerStr string, msg *SyncMessage) (*SyncMessage, error)

	// RespondToCurrentInstanceLastChangeRoundMsg responds to a GetCurrentInstanceLastChangeRoundMsg
	RespondToCurrentInstanceLastChangeRoundMsg(stream SyncStream, msg *SyncMessage) error
