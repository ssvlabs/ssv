...
func NewPubSub(ctx context.Context, logger *zap.Logger, cfg *PubSubConfig, metrics Metrics, committeesProvider CommitteesProvider, badPeersCollector peers.BadPeersCollector) (*pubsub.PubSub, Controller, error) {
	...
	if cfg.ScoreIndex != nil || inspector != nil {
		...
		if inspector == nil {
			...
			inspector = scoreInspector(logger, cfg.ScoreIndex, scoreInspectLogFrequency, metrics, peerConnected, peerScoreParams, topicScoreFactory, badPeersCollector)
		}
