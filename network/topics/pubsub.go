...
func NewPubSub(ctx context.Context, logger *zap.Logger, cfg *PubSubConfig, metrics Metrics, gossipScoreIndex peers.GossipScoreIndex) (*pubsub.PubSub, Controller, error) {
	...
	if cfg.ScoreIndex != nil || inspector != nil {
		...
		if inspector == nil {
			...
			inspector = scoreInspector(logger, cfg.ScoreIndex, scoreInspectLogFrequency, metrics, peerConnected, gossipScoreIndex)
		}
