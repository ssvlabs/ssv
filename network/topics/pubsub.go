...
func NewPubSub(ctx context.Context, logger *zap.Logger, cfg *PubSubConfig, metrics Metrics, gossipSubScoreIndex peers.GossipSubScoreIndex) (*pubsub.PubSub, Controller, error) {
	...
	if cfg.ScoreIndex != nil || inspector != nil {
		...
		if inspector == nil {
			...
			inspector = scoreInspector(logger, cfg.ScoreIndex, scoreInspectLogFrequency, metrics, peerConnected, gossipSubScoreIndex)
		}
