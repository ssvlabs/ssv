...
type Config struct {
	...
	MaxPeers         int           `yaml:"MaxPeers" env:"P2P_MAX_PEERS" env-default:"60" env-description:"Connected peers limit. At the moment, this is grown (up to 150) when the node is an operator which is subscribed to many subnets."`
