...
type Config struct {
	...
	MaxPeers         int           `yaml:"MaxPeers" env:"P2P_MAX_PEERS" env-default:"60" env-description:"Connected peers limit. If this is lower than the ideal MaxPeers for the operator's subnets, it will be increased (up to 150)."`
