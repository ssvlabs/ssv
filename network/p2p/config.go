...
type Config struct {
	...
	MaxPeers         int           `yaml:"MaxPeers" env:"P2P_MAX_PEERS" env-default:"60" env-description:"Connected peers limit for connections. This value is applied if operator has 1-4 committees. For 5+ committees this value is overridden with 150 to make sure there are enough peers"`
