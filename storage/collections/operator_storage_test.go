...
var (
	pkPem  = "-----BEGIN RSA PUBLIC KEY-----\\nTwIDAQAB\n-----END RSA PUBLIC KEY-----\n"
...
func TestSaveAndGetPrivateKey(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, pkPem, string(operatorPublicKey))
}
