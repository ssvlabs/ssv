...
func (d *DutyTraceStoreMetrics) SaveCommitteeDuties(slot phase0.Slot, role spectypes.RunnerRole, duties []*exporter.CommitteeDutyTrace) error {
	start := time.Now()
	defer func() {
...
func (d *DutyTraceStoreMetrics) SaveCommitteeDuty(role spectypes.RunnerRole, duty *exporter.CommitteeDutyTrace) error {
	start := time.Now()
	defer func() {
...
func (d *DutyTraceStoreMetrics) GetCommitteeDuty(slot phase0.Slot, role spectypes.RunnerRole, id spectypes.CommitteeID) (duty *exporter.CommitteeDutyTrace, err error) {
	start := time.Now()
	defer func() {
...
func (d *DutyTraceStoreMetrics) GetCommitteeDuties(slot phase0.Slot, roles ...spectypes.RunnerRole) ([]*exporter.CommitteeDutyTrace, error) {
	start := time.Now()
	defer func() {
