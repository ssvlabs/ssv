...
type ValidatorStore interface {
	...
	Committee(id ssvtypes.CommitteeID) *Committee
...
type validatorStore struct {
	...
	byCommitteeID    map[ssvtypes.CommitteeID]*Committee
...
//		byCommitteeID:    make(map[ssvtypes.CommitteeID]*Committee),
...
//}
//
//func (c *validatorStore) Committee(id ssvtypes.CommitteeID) *Committee {
//	c.mu.RLock()
//	defer c.mu.RUnlock()
//
