...
func TestSaveAndGetPrivateKeyHash(t *testing.T) {
	...
	parsedPrivKeyHash, err := parsedPrivKey.Hash()
	require.NoError(t, err)
...
//				require.NoError(t, err)
//
//				require.NoError(t, operatorStorage.SavePrivateKeyHash(existingPrivKeyHash))
//
//				hash, found, err := operatorStorage.GetPrivateKeyHash()
//				require.NoError(t, err)
//				require.True(t, found)
//				require.NotNil(t, hash)
//
//				require.Equal(t, existingPrivKeyHash, hash)
//			}
//
//			pk, err := operatorStorage.SavePrivateKeyHash(test.passedKey)
...
//				require.NoError(t, err)
//				require.GreaterOrEqual(t, len(hash), 32)
//				return
//			}
...
//				require.NoError(t, err)
//				require.Equal(t, string(existKeyByte), string(rsaencryption.PrivateKeyToByte(hash)))
//				return
//			}
//			// not exist && passed and exist && passed
//			passedKeyByte, err := base64.StdEncoding.DecodeString(test.passedKey)
//			require.NoError(t, err)
//			require.Equal(t, string(passedKeyByte), string(rsaencryption.PrivateKeyToByte(hash)))
//		})
//	}
//}
