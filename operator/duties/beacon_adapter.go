...
type prefetchingBeacon struct {
	...
	vstore registrystorage.ValidatorStore
...
func NewPrefetchingBeacon(log *zap.Logger, inner beaconprotocol.BeaconNode, cfg *networkconfig.Beacon, vstore registrystorage.ValidatorStore) *prefetchingBeacon {
