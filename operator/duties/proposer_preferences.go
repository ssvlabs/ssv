...
// any earlier tick does nothing. A reorg recheck flagged since the last tick is consumed here, forcing the
// lookahead's dependent roots to be re-evaluated; an earlier tick just drops it, as nothing has been emitted
// yet. Ticks within the grace after a validator-set change are skipped entirely.
