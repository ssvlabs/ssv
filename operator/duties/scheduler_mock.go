...
func (mr *MockDutiesExecutorMockRecorder) ExecuteCommitteeDuties(logger, duties interface{}) *gomock.Call {
...
func (mr *MockDutiesExecutorMockRecorder) ExecuteDuties(logger, duties interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDutiesExecutorMockRecorder) ExecuteGenesisDuties(logger, duties interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDutyExecutorMockRecorder) ExecuteCommitteeDuty(logger, committeeID, duty interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDutyExecutorMockRecorder) ExecuteGenesisDuty(logger, duty interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
