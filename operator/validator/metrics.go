...
func (c *controller) reportValidatorStatus(pk []byte, meta *beacon.ValidatorMetadata, logger *zap.Logger) {
	logger = logger.With(fields.PubKey(pk), fields.ValidatorMetadata(meta))
	if meta == nil {
