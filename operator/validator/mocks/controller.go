...
// Source: ./operator/validator/controller.go
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=./operator/validator/mocks/controller.go -source=./operator/validator/controller.go
//
...
func (mr *MockControllerMockRecorder) ExitValidator(pubKey, blockNumber, validatorIndex, ownValidator interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
