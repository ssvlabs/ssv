...
func (m *MockP2PNetwork) Unsubscribe(vpk types.ValidatorPK) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Unsubscribe", vpk)
	ret0, _ := ret[0].(error)
	return ret0
}

// Unsubscribe indicates an expected call of Unsubscribe.
func (mr *MockP2PNetworkMockRecorder) Unsubscribe(vpk any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Unsubscribe", reflect.TypeOf((*MockP2PNetwork)(nil).Unsubscribe), vpk)
}
