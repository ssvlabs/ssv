...
// Hash: 8639abd8831ca604f1c8d58fc42f64184cf2841f605c44f532df1b79eb31d930
// Version: 0.1.3
package traces
...
func (c *CommitteeDutyTrace) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (6) 'ProposalData'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(c.ProposalData)

	// Offset (7) 'SyncCommittee'
	dst = ssz.WriteOffset(dst, offset)
...
func (c *CommitteeDutyTrace) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (7) 'SyncCommittee'
	if o7 = ssz.ReadOffset(buf[64:68]); o7 > size || o6 > o7 {
		return ssz.ErrOffset
	}

	// Offset (8) 'Attester'
	if o8 = ssz.ReadOffset(buf[68:72]); o8 > size || o7 > o8 {
		return ssz.ErrOffset
	}
...
func (s *SignerData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.ValidatorIdx); size > 3000 {
		err = ssz.ErrListTooBigFn("SignerData.ValidatorIdx", size, 3000)
		return
	}
