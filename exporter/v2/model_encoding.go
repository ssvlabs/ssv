...
// Hash: 08b13fbfed201b1792307f393a03ba5e674745333219b0cffa6cf923d42a4504
// Version: 0.1.3
package exporter
...
func (s *SignerData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.ValidatorIdx); size > 13 {
		err = ssz.ErrListTooBigFn("SignerData.ValidatorIdx", size, 13)
		return
	}
