...
// Hash: c59f825b9ae4eeb59e9c834fb4c44aa718f68c55b693db2c067be26ee3a5bd4b
// Version: 0.1.3
package exporter
...
func (d *DecidedTrace) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'ReceivedTime'
	d.ReceivedTime = ssz.UnmarshalTime(buf[44:52])
...
func (q *QBFTTrace) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'ReceivedTime'
	dst = ssz.MarshalTime(dst, q.ReceivedTime)
...
func (q *QBFTTrace) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'ReceivedTime'
	q.ReceivedTime = ssz.UnmarshalTime(buf[48:56])
...
func (q *QBFTTrace) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'ReceivedTime'
	hh.PutUint64(uint64(q.ReceivedTime.Unix()))
...
func (c *CommitteeDutyTrace) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (7) 'AttestationDataRoot'
	dst = append(dst, c.AttestationDataRoot[:]...)

	// Field (8) 'SyncCommitteeMessageRoot'
...
func (c *CommitteeDutyTrace) UnmarshalSSZ(buf []byte) error {
	...
	// Field (7) 'AttestationDataRoot'
	copy(c.AttestationDataRoot[:], buf[60:92])

	// Field (8) 'SyncCommitteeMessageRoot'
	copy(c.SyncCommitteeMessageRoot[:], buf[92:124])
...
func (s *SignerData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'ReceivedTime'
	dst = ssz.MarshalTime(dst, s.ReceivedTime)

	// Field (0) 'Signers'
	if size := len(s.Signers); size > 13 {
		err = ssz.ErrListTooBigFn("SignerData.Signers", size, 13)
		return
	}
...
func (s *SignerData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'ReceivedTime'
	s.ReceivedTime = ssz.UnmarshalTime(buf[4:12])
	...
	// Field (0) 'Signers'
	{
		...
		for ii := 0; ii < num; ii++ {
			s.Signers[ii] = spectypes.OperatorID(ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8]))
		}
	}
	return err
}
...
func (s *SignerData) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (1) 'ReceivedTime'
	hh.PutUint64(uint64(s.ReceivedTime.Unix()))
