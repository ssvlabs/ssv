...
// Hash: 6e19b9b279acb29d30d15b4029d06aa4f5657ccf263e0879c519bee66c5d38cc
// Version: 0.1.3
package exporter
...
func (c *CommitteeMessageTrace) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'ReceivedTime'
	c.ReceivedTime = ssz.UnmarshalTime(buf[1036:1044])
	...
	// Field (1) 'Validators'
	{
		...
		// Convert existing Validators to uint64 slice for ExtendUint64
		tmp := make([]uint64, len(c.Validators))
		for i, v := range c.Validators {
			tmp[i] = uint64(v)
		}
		// Extend the temporary slice and create new Validators slice with correct type
		tmp = ssz.ExtendUint64(tmp, num)
		c.Validators = make([]phase0.ValidatorIndex, len(tmp))
		for ii := 0; ii < num; ii++ {
