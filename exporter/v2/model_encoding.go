...
// Hash: 5909191be4b4882ef7d8241a17f34caee6dff722f6bde5d54d6f8037b9f7de68
// Version: 0.1.3
package exporter
...
func (c *CommitteePartialSigMessageTrace) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Messages'
	if size := len(c.Messages); size > 1512 {
		err = ssz.ErrListTooBigFn("CommitteePartialSigMessageTrace.Messages", size, 1512)
		return
	}
...
func (c *CommitteePartialSigMessageTrace) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'Signer'
	c.Signer = spectypes.OperatorID(ssz.UnmarshallUint64(buf[8:16]))
	...
	// Field (3) 'ReceivedTime'
	c.ReceivedTime = ssz.UnmarshalTime(buf[20:28])

	// Field (2) 'Messages'
	{
		buf = tail[o2:]
		num, err := ssz.DivideInt2(len(buf), 48, 1512)
		if err != nil {
			return err
		}
