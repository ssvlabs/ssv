...
//	message2 "github.com/bloxapp/ssv/protocol/v1/message"
//	qbft2 "github.com/bloxapp/ssv/protocol/v1/qbft"
//	controller2 "github.com/bloxapp/ssv/protocol/v1/qbft/controller"
...
//	"github.com/bloxapp/ssv/message2col/v1/blockchain/beacon"
//	"github.com/bloxapp/ssv/message2col/v1/message"
//	"github.com/bloxapp/ssv/message2col/v1/qbft"
//	"github.com/bloxapp/ssv/message2col/v1/qbft/controller"
...
//			message2.RoleTypeAttester.String())),
//		lock:  &sync.Mutex{},
//		state: &state{},
//	}
//	return &r
...
//func (r *decidedReader) Share() *beaconprotocol.Share {
...
//			return nil
//		}, 3); err != nil {
//			controller2.ReportIBFTStatus(r.validatorShare.PublicKey.SerializeToHexStr(), false, true)
...
//	}
//	controller2.ReportIBFTStatus(r.validatorShare.PublicKey.SerializeToHexStr(), true, false)
...
//func (r *decidedReader) GetMsgResolver(networkMsg network.NetworkMsg) func(msg *message2.SignedMessage) {
//	switch networkMsg {
//	case network.NetworkMsg_DecidedType:
//		return r.onMessage
//	}
//	return func(msg *message2.SignedMessage) {
//		r.logger.Warn(fmt.Sprintf("handler type (%s) is not supported", networkMsg))
//	}
//}
//
//func (r *decidedReader) onMessage(msg *message2.SignedMessage) {
...
//		return
//	}
//	go func(msg *message2.SignedMessage) {
//		r.lock.Lock()
//		defer r.lock.Unlock()
...
//func (r *decidedReader) handleNewDecidedMessage(msg *message2.SignedMessage) (bool, error) {
//	logger := r.logger.With(messageFields(msg)...)
...
//func (r *decidedReader) checkDecided(msg *message2.SignedMessage) (bool, error) {
//	decided, found, err := r.storage.GetDecided(r.identifier, msg.Message.Height)
//	if err != nil {
//		return false, err
//	}
//	if !found {
...
//func (r *decidedReader) checkHighestDecided(msg *message2.SignedMessage) error {
//	logger := r.logger.With(messageFields(msg)...)
...
//func (r *decidedReader) validateDecidedMsg(msg *message2.SignedMessage) error {
...
//}
//
//func validateDecidedMsg(msg *message2.SignedMessage, share *beacon.Share) error {
//	p := pipeline.Combine(
//		auth.BasicMsgValidation(),
//		auth.MsgTypeCheck(message2.RoundState_Commit),
//		//auth.AuthorizeMsg(share), // TODO
//		auth.ValidateQuorum(share.ThresholdSize()),
//	)
//	return p.Run(msg)
//}
//
//func validateMsg(msg *message2.SignedMessage, identifier []byte) error {
//	p := pipeline.Combine(
//		auth.BasicMsgValidation(),
...
//}
//
//func newDecidedAPIMsg(msg *message2.SignedMessage, pk string) api.Message {
//	return api.Message{
...
//		Data: []*message2.SignedMessage{msg},
//	}
//}
//
