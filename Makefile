...
unit-test:
	...
	@go test -tags blst_enabled -timeout 20m -race -covermode=atomic -coverprofile=coverage.out -p 1 `go list ./network/p2p/... | grep -ve "spectest\|integration\|ssv/scripts/"`
