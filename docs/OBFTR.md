...
|---|---|---|
| Healthy (all honest receive V_{L_0}) | Round 1: σ-quorum reaches within Phase 1 + Phase 2 + Phase 2.5 budget (~1000ms = 5 BTT). ✓ at L_0. | Round 1: PROPOSE→PREPARE→COMMIT (3 RTTs) + post-consensus (1 RTT). ~800ms. ✓ |
