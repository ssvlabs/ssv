...
The **Phase 2a/2b split** (see [2abOBFT](2abOBFT.md)) is the structurally correct fix for full equivocation recovery; documented as a future improvement, not in current OBFTR.
