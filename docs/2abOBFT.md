...
| Partial-synchrony absorption window | Per-layer `Δ_2a + B_k − 1·BTT` (single round) — L_0 = 3·BTT + RefloodDelay = 1300ms at Config A default RefloodDelay; deeper layers wider (L_{K-1} ≈ T_verdict_start + 1·BTT). |
