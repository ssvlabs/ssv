...
**SSV-side** (multi-BN setups only — 1850ms triggers the safe-max startup warning since it exceeds the ~1100ms threshold; see [Multi-BN setup](#multi-bn-setup); single-BN operators skip this):
```yaml
eth2:
