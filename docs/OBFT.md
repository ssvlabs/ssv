...
At Config A (P99=150ms, δ=50ms, recommended sizing: Δ_2 = 2 BTT, Δ_3 = ε_3): `Δ_minicon = 400ms`; total slot budget post-`T_commit` ≈ 900ms (vs bare OBFT's ~500ms); submission headroom drops from ~2.0s to ~1.6s within the 4s relay cutoff (T_commit anchored at slot_start + 1.5s).
