...
| h_V=1 selective-delivery deadlock | Class B grief (slot-miss); not recovered in-protocol — algebraic deadlock at f=1, n=4 (σ-pool=2 < qV; NR-pool=2 < qEnc). Deterred via Assumption 4 across slots. | Recovered (verdict-quorum-short → fall-through) |
