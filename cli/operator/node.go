...
func runNode(ctx context.Context, cfg *config, logger *zap.Logger) error {
	...
	// goclient consumes the block-fetch values (BlockFetchPath / ProposalSoftTimeout /
	// ProposalSoftDeadline) that resolveAndValidate already resolved onto cfg.ConsensusClient.
