...
var StartNodeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var decidedListener dutytracer.DecidedListener
		if cfg.WsAPIPort != 0 {
			...
			decidedListener = decided.NewDecidedListener(logger, networkConfig.DomainType, ws)
		}
		...
		if cfg.ExporterOptions.Enabled {
			...
			case exporter.ModeArchive:
				...
				collector = dutytracer.New(logger,
					...
					dstore, networkConfig.BeaconConfig, decidedListener)
