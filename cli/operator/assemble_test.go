...
// test path actually invokes. In operator mode with Doppelganger disabled, assemble() never calls
...
// Test_assemble_wiresOperatorNode is the in-process smoke test for the assemble() seam: with
...
// Test_assembled_startNetwork_wiresStatsRegardlessOfDynamicMaxPeers is the CLI-level regression for
...
func Test_assembled_startNetwork_wiresStatsRegardlessOfDynamicMaxPeers(t *testing.T) {
