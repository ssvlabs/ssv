	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		cfg := p2p.Config{
			...
			BootstrapNodeAddr: []string{
				// deployemnt
				"enr:-LK4QLeAok4EzHnP8s28sNQgbNEjXUKYabb4r4BipePM-06EU8xBusy9QkgapIiYgbA4sJ6RfmLcV7ZrAiNRZ-PpF-0Bh2F0dG5ldHOIAAAAAAAAAACEZXRoMpD1pf1CAAAAAP__________gmlkgnY0gmlwhArCIQOJc2VjcDI1NmsxoQO8KQz5L1UEXzEr-CXFFq1th0eG6gopbdul2OQVMuxfMoN0Y3CCE4iDdWRwgg-g",
				// ssh
